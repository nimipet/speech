const bitcoinBubble = [
  "Satoshi Nakamoto is a fictitioius name of the Bitcoin creator or creators, to this day no one knows who the actual creator is.",
  ...
  "On May 22, 2010 two pizzas were purchased from Papa John's for 10K bitcoin. Current value for those pizzas as of June 2018 is around $80 M.",
  ...
  "Bitcoin uses an cryptographic hash algorithm called SHA265 for mining.",
  ...
  "The first transfer of Bitcoin took place on January 21, 2009. Satoshi Nalamoto transferred 100 BTC to Harold Thomas Finney.",
  "Lamborghini was the first automotive company in the world to accept Bitcoin.",
  "Bitcoin is the first decentralized digital currency, aka crypto currency, that solves the double spending problem.",
  "Bitcoins are created through 'mining'. Mining involves solving a complex mathematical problems. Miners are rewarded with Bitcoins.",
  ...
  "The first Bitcoin transaction took place in outerspace when cloud mining provider, Genesis Mining, made a transfer of 1 Bitcoin.",
  ...
  "There are currently 1,640 different crypto currencies out there.",
...
const cryptoBubble = [
  "The blockchain is a public ledger that records crypto currency transactions, each block containing a hash of the previous block.",
  "The term Altcoin is short for alternative protocol asset and the term used to refer to derivatives of bitcoin.",
  "There are two ways of adding a block to a block chain, proof-of-work (PoW) and proof-of-stake (PoS).",
  ...
  "Jordan Kelley, founder of Robocoin, launched the first bitcoin ATM in the United States on February 20, 2014.",
...
const nimiqBubble = [
  ...
  "Nimiq uses a very efficient alogrith called Argon2 for mining. It is ASIC and GPU resistent."
]
